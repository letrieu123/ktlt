...
name_label = tk.Label(info_frame, text="Họ và Tên: le thanh khanh trieu", font=("Arial", 12))
name_label.grid(row=0, column=0, sticky="w")

dob_label = tk.Label(info_frame, text="Ngày Sinh: 06/01/2004", font=("Arial", 12))
dob_label.grid(row=1, column=0, sticky="w")

mssv_label = tk.Label(info_frame, text="MSSV: 235752021610117", font=("Arial", 12))
